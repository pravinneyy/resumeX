...
import { LayoutDashboard, Briefcase, BarChart2, BookOpen, ChevronLeft, Sparkles } from "lucide-react"
...
const navItems = [
  ...
  { label: "Compare", icon: BarChart2, href: "/candidate/compare" },
  { label: "Practice", icon: BookOpen, href: "/candidate/practice" },
]
